...
public abstract class DisplayHelper {
	...
	/**
	 * Until {@link #condition()} becomes <code>true</code> or the timeout elapses,
	 * call {@link Display#sleep()} and run the event loop.
	 * <p>
	 * If <code>timeout &lt; 0</code>, the event loop is never driven and only the
	 * condition is checked. If <code>timeout == 0</code>, the event loop is driven
	 * at most once, but <code>Display.sleep()</code> is never invoked.
	 * </p>
	 * 
	 * @param display
	...
	/**
	 * Call {@link Display#sleep()} and run the event loop until the given timeout
	 * has elapsed.
	 * <p>
	 ...
	 * <code>true</code> if any events were processed, <code>false</code> if not.
	 * <p>
	 * If <code>timeout &lt; 0</code>, nothing happens and false is returned. If
	 * <code>timeout == 0</code>, the event loop is driven exactly once, but
	 * <code>Display.sleep()</code> is never invoked.
	 * </p>
	 * 
	 ...
	 * {@link #waitForCondition(Display, int)} to return before the timeout elapses.
	 * 
	 * @return <code>true</code> if the condition is met, <code>false</code> if the
	 *         event loop should be driven some more
	 */
	 ...
	 * @param display
	 *            the display
	 * @return if <code>display.readAndDispatch</code> returned <code>true</code> at
	 *         least once
	 */
	 ...
	 *            the timeout in milliseconds
	 * @param interval
	 *            the interval to re-check the condition in milliseconds
	 * @return <code>true</code> if the condition became <code>true</code>,
	 *         <code>false</code> if the timeout elapsed
	 */
